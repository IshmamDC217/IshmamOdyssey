    ...
    <section className="homepage">
      ...
      <div className="relative h-screen grid grid-cols-2">
        <div className="flex flex-col md:flex-row md:justify-between min-h-screen ml-6">
          ...
          >
            <h2 className="text-3xl mb-12 md:text-5xl text-white font-bold">Hi there, I'm</h2>
            <animated.h1 style={fadeIn} className=" ishahm text-4xl md:mb-12 text-[#f5c896] font-bold">Ishmam Ahmed</animated.h1>
            ...
            <h4 className="text-lg md:text-3xl text-[#f5c896] font-bold mb-5">
              <Typewriter
                options={{
            ...
            <div>
              <animated.p
                style={fadeIn}
                className="text-xs md:text-sm lg:text-xl font-semibold max-w-[750px] text-white txt pb-10"
              >
                Allow me to introduce myself as a <b className='text-[#f5c896]'>software engineer</b> and <b className='text-[#f5c896]'>musician</b>. Having a Computer Science degree specializing in Artificial Intelligence, I have a strong foundation in both technical problem-solving and innovative thinking. As an <b className='text-[#f5c896]'>instrumentalist</b>, I channel my creative passion through music.
                <br /><br />
                Currently, I'm immersed in two exciting worlds: by day, I work as a full-stack software engineer at <a href='https://www.hlrlookup.com' rel="noopener noreferrer" className='font-bold underline hover:text-[#f5c896]'>HLR Lookup</a>, and by night, I'm shredding the guitar for the progressive rock band, <a href='https://metoracliffs.netlify.app' rel="noopener noreferrer" className='font-bold underline hover:text-[#f5c896]'>Metora Cliffs</a>, both based in Leeds. Blending my technical expertise and musical passion, I create captivating experiences at the intersection of technology and music.
              </animated.p>
            </div>
            <a href='https://linktr.ee/jazzmaster?utm_source=linktree_profile_share&ltsid=ef8fc291-9300-4371-b17a-e94d030e7559'
              className='text-white mt-5 p-3 rounded-lg bg-[#000000] font-semibold'>Check out my Link Tree!</a>
          </animated.div>
        </div>
